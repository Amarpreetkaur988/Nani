...
public class BuyerOtpVerification extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_otp_verification);

        CommonUtils.CheckService(BuyerOtpVerification.this);
        activity = BuyerOtpVerification.this;
    ...
    private void resendVerificationToken() {
        viewModel.ResendVerificationToken(activity, id).observe(BuyerOtpVerification.this, new Observer<LoginRegisterModelClass>() {
            @Override
    ...
    private void matchVerificationToken() {
        ...
        if (otp.length() == 4) {
            viewModel.MatchVerification(activity, id, otp).observe(BuyerOtpVerification.this, new Observer<LoginRegisterModelClass>() {
                @Override
                public void onChanged(@Nullable LoginRegisterModelClass registerModelClass) {
                    if (registerModelClass.getSuccess().equalsIgnoreCase("1")) {
    ...
    private void verify1() {
        final Dialog dialog = new Dialog(BuyerOtpVerification.this);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(BuyerOtpVerification.this, BuyerHomeActivity.class).putExtra("Type","1"));
                finishAffinity();
                dialog.dismiss();
            }
        });
