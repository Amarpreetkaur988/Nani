...
import com.omninos.nani.adapter.DiscoverImageAdapter;
...
public class BuyerDiscoverItemDetails extends AppCompatActivity implements View.OnClickListener {
    ...
    private DiscoverModelClass.PostList detail;
    private int quantity;
    private RecyclerView item_desc_images_recycler;
    private DiscoverImageAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buyer_discover_item_details);

        CommonUtils.CheckService(BuyerDiscoverItemDetails.this);
        initView();
        SetUp();
    }
    ...
    private void SetUp() {
        detail = (DiscoverModelClass.PostList) getIntent().getSerializableExtra("Details");
...
//        adapter = new DiscoverImageAdapter(BuyerDiscoverItemDetails.this, detail.getPostImage(), new DiscoverImageAdapter.Choose() {
//            @Override
...
//        item_desc_images_recycler.setAdapter(adapter);
        ...
        adapter = new DiscoverImageAdapter(BuyerDiscoverItemDetails.this, detail.getPostImagess(), new DiscoverImageAdapter.Choose() {
            @Override
            public void Select(String path) {
                ShowImg(path);
            }
    ...
    public void ShowImg(String path) {
        View customView = LayoutInflater.from(BuyerDiscoverItemDetails.this).inflate(R.layout.image_popup, null);
        dialog = new AlertDialog.Builder(BuyerDiscoverItemDetails.this).create();
        ...
        Glide.with(BuyerDiscoverItemDetails.this).load(path).into(ViewedImage);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.choose_address_btn_item_des:
                ...
                App.getSingleton().setFoodImg(detail.getPostImagess().get(0).getImage());
                startActivity(new Intent(BuyerDiscoverItemDetails.this, ChooseAddressActivity.class));
                break;
