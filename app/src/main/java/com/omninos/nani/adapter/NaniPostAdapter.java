 ...
 */
public class NaniPostAdapter extends RecyclerView.Adapter<NaniPostAdapter.MyViewHolder> {
    ...
    public NaniPostAdapter(Context context, List<GetNaniPostModel.Detail> list, Choose choose) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.nani_post_layout, parent, false);
