 ...
 */
public class BuyerSubscriptionPostAdapter extends RecyclerView.Adapter<BuyerSubscriptionPostAdapter.MyViewHolder> {

    private Context context;
    private List<GetNaniPostModel.Detail> list;
    private BuyerPostAdapter.Choose choose;


    public BuyerSubscriptionPostAdapter(Context context, List<GetNaniPostModel.Detail> list, BuyerPostAdapter.Choose choose) {
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.buyer_horizonatal_post_layout, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.vertical_feed_card_item.setOnClickListener(new View.OnClickListener() {
            @Override
